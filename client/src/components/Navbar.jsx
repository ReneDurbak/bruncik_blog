...
return(
    <>
    <header className="w-full bg-cyan-700 text-white fixed ">
  <div className="p-6 md:flex md:items-center md:justify-between max-w-[1240px] mx-auto px-4">
    ...
    <ul className="md:flex md:items-center hidden md:ml-10">
      <li className="sm:mx-0 md:mx-5 lg:mx-5  md:text-base lg:text-xl hover:text-neutral-400 duration-300">Home</li>
      <li className="sm:mx-0 md:mx-5 lg:mx-5  md:text-base lg:text-xl hover:text-neutral-400 duration-300">About</li>
      <li className="sm:mx-0 md:mx-5 lg:mx-5  md:text-base lg:text-xl hover:text-neutral-400 duration-300">Articles</li>
