  ...
  const handleUpdateProfile = async(e) => {
    ...
    return(
        <>
            ...
            <div className="flex flex-col  px-10 py-6 rounded-[30px] w-[40rem] outline outline-[1px] shadow-2xl  bg-gradient-to-br from-red-100 via-yellow-200 to-purple-300">
