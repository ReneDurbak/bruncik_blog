...
function Articles({ articles }) {
    ...
    setFilteredArticles(
      articles.filter((article) => {
        ...
        const sectionMatches =
          ...
          (article.section && article.section._id === selectedFilterId);
  ...
  function sendEmail(e) {
    ...
    if (rgExp.test(email)) {
      ...
      emailjs
        .sendForm("test123", "template_nbi58c7", e.target, "6Rv8j2Hq5xEQ8kKOX")
        .then((res) => {
          console.log(res);
        })
  ...
  return (
    <>
      ...
      <div
        id="articles"
        className="text-white 2xl:pt-[200px]  2xl:pb-[75px] xl:pt-[250px] xl:pb-16 lg:pt-[350px] lg:pb-[115px]  md:pt-[300px] md:pb-[50px] sm:pt-[150px] sm:pb-[120px] pt-[260px] pb-20   md:tracking-normal   2xl:bg-[url('/src/assets/articlesintrobg.png')] xl:bg-[url('/src/assets/articlesintrobglaptopxl.png')] md:bg-[url('/src/assets/articlesintrobgtablet.png')] bg-[url('/src/assets/articlesintrobgmobile.png')] bg-cover font-spectral "
      >
        <div className="2xl:max-w-[1680px] max-w-[1380px] mx-auto 2xl:px-20 sm:px-10 px-6 grid sm:grid-cols-2 sm:grid-flow-col	lg:gap-8 sm:gap-8 2xl:mt-4 xl:mt-[-25px] lg:mt-[-185px] md:mt-[-135px] sm:mt-[-25px] mt-[-190px]">
          <div className="col-span-2 sm:mt-0 2xl:mt-[-25px]">
            <h1 className="2xl:text-8xl lg:text-7xl mb-6 text-6xl tracking-wide">
              Articles
            </h1>
            ...
            <div className="hidden lg:block">
              <div className=" tracking-normal 2xl:text-lg xl:text-[16px] md:text-[15px] break-words text-black bg-slate-100 rounded-2xl py-5 px-6 mt-[100px] font-poppins shadow-2xl">
                Welcome to my articles homepage, the vibrant ❤️ of this
                platform, where each word brims with passion and dedication.
                Whether you're a new here or a loyal reader, I'm thrilled you're
                here. I'm committed to sharing wisdom 🧠, tips 💡, and
                experiences 🌟 to help you thrive in life, firmly believing that
                continuous learning and growth are essential.
                <br />I hope you'll find inspiration 💫 and practical guidance
                here. Thank you for your support 🙏, and let's embrace the
                journey of lifelong learning 📚 and growth 🌱 together! 🤝
              </div>

              <p className="font-bold mt-[80px]  2xl:text-3xl xl:text-2xl md:text-xl text-base font-poppins">
                Enjoy!
              </p>
            </div>
          </div>
              ...
              <form onSubmit={sendEmail}>
                <div className="bg-white rounded-2xl sm:px-6 px-4 sm:py-5 py-3 text-center font-spectral">
                  <div className="w-full py-2">
                    <div className="mx-0">
                      <h1 className="uppercase text-black underline underline-offset-4 font-bold sm:text-xl text-lg">
                        Try out my newsletter
                      </h1>
                      <section className=" sm:my-2 my-1">
                        <div className="text-black mx-4 text-base">
                          Sign up for our weekly newsletter and get a dose of
                          inspiration!{" "}
                        </div>
                      </section>
                      ...
                      <section>
                        <input
                          ...
                          className="bg-white rounded-xl italic mt-2 mb-1 outline-1 outline outline-offset-1 outline-black focus:outline focus:shadow-lg sm:py-[10px] py-[6px]  text-black text-center w-full sm:text-base text-sm"
                      ...
                      <section>
                        <input
                          type="submit"
                          value="Subscribe"
                          className="active:bg-white active:text-black italic bg-slate-950 rounded-xl mt-2 hover:shadow-xl ease-in-out duration-300 sm:py-3 py-[10px] text-white text-center w-full sm:text-base text-sm"
                          placeholder="My email address is..."
                        />
                      </section>
                      <div
                      ...
                      <div className="text-black mt-4  text-[11px] italic">
                        "Zero spam. Only the finest ideas you'll discover
                        online."
                      </div>
                    </div>
                  </div>
            ...
            <form onSubmit={sendEmail} className="border-l-2">
              <div className="bg-white rounded-2xl px-6  xl:px-4 md:px-5 2xl:pt-5 2xl:pb-2 xl:py-3 md:py-1 ml-4 text-center font-spectral">
                <div className="lg:max-w-[320px] w-full py-2">
                  <div className="mx-0">
                    <h1 className="uppercase text-black underline underline-offset-4 font-bold 2xl:text-xl xl:text-lg lg:text-base md:text-[15px] mt-1">
                      Try out my newsletter
                    </h1>
                    <section className="xl:my-1 sm:my-2 my-1">
                      <div className="text-black xl:mx-8 md:mx-2 2xl:text-base xl:text-sm md:text-[12px] text-[12px]">
                        Sign up for our weekly newsletter and get a dose of
                        inspiration!{" "}
                      </div>
                    </section>
                    ...
                    <section>
                      <input
                        ...
                        name="user_Email"
                        onChange={(e) => setEmail(e.target.value)}
                        className="bg-white rounded-xl mt-2 mb-1 outline-2 outline outline-offset-1 outline-black focus:outline focus:shadow-lg 2xl:py-[10px] xl:py-[8px] md:py-[4px] sm:py-[2px] py-[2px] text-black text-center w-full 2xl:text-base sm:text-sm text-[13px]"
                        placeholder="My email address is..."
                      />
                    </section>
                    ...
                    <input
                      type="submit"
                      value="Subscribe"
                      className="active:bg-white active:text-black italic bg-slate-950 rounded-xl mt-2 hover:shadow-xl ease-in-out duration-300  2xl:py-3 xl:py-[8px] md:py-[6px] sm:py-[4px] py-[5px] text-white text-center w-full 2xl:text-base sm:text-sm text-[13px]"
                      placeholder="My email address is..."
                    />
                    ...
                    <div className="text-black xl:mt-4 sm:mt-3 mt-2 2xl:text-[13px] xl:text-[12px] md:text-[11px] text-[11px] italic">
                      "Zero spam. Only the finest ideas you'll discover online."
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div className="lg:hidden block max-w-[1380px] mx-auto sm:px-10 px-6 xl:mt-[-115px] lg:mt-[-95px] md:mt-[-15px] sm:mt-[-15px] mt-[-25px]">
          <div className="2xl:text-xl xl:text-[18px] md:text-[15px] sm:text-[15px] text-[14px] tracking-normal  break-words text-black bg-slate-100 rounded-2xl 2xl:py-5 xl:py-4 md:py-3 md:px-6 sm:py-3 sm:px-3 px-3 py-3 lg:mt-[100px] font-poppins shadow-2xl">
            Welcome to my articles homepage, the vibrant ❤️ of this platform,
            where each word brims with passion and dedication. Whether you're a
            new here or a loyal reader, I'm thrilled you're here. I'm committed
            to sharing wisdom 🧠, tips 💡, and experiences 🌟 to help you thrive
            in life, firmly believing that continuous learning and growth are
            essential. I hope you'll find inspiration 💫 and practical guidance
            here. Thank you for your support 🙏, and let's embrace the journey
            of lifelong learning 📚 and growth 🌱 together! 🤝{" "}
          </div>

          <p className="font-bold mt-[80px] sm:text-lg text-base font-poppins">
            Enjoy!
          </p>
        </div>
        ...
        <div className="text-center 2xl:mt-[-155px] xl:mt-[-200px] lg:mt-[-175px] md:mt-[-175px] sm:mt-[-125px]">
          <div>
            <Link to="mainArticles" smooth={true} offset={-50}>
              <img
                src={arrowDown}
                className="text-center max-w-[1240px] mx-auto 2xl:mt-[240px] xl:mt-[190px] lg:mt-[225px] md:mt-[215px] sm:mt-[175px] mt-[15px] 2xl:w-[45px]  lg:w-[35px] md:w-[30px] sm:w-[32px] 
    w-[25px] duration-500 ease-in-out hover:scale-125 active:scale-125"
              />{" "}
            </Link>
          </div>
        </div>
      ...
      <div>
        <h2
          className="font-poppins mx-auto text-center 2xl:text-6xl xl:text-7xl lg:text-6xl sm:text-5xl text-5xl font-thin 2xl:py-[65px] sm:py-[50px] py-[35px]	"
          id="mainArticles"
        >
          Topics
        </h2>
          ...
          <div className="shadow-lg flex justify-between outline 2xl:outline-[2px] outline-[1px] rounded-full focus:outline-black sm:mx-0 lg:mx-6 sm:px-1 lg:px-2 mx-12 mt-4 sm:mt-0 lg:mt-2 lg:mb-1 mb-1 sm:mb-0 w-full sm:w-auto">
            <div className="my-auto flex-grow">
              <input
                ...
                placeholder="Search..."
                className="placeholder:not-italic outline-none sm:pt-2 lg:pt-3 pt-1 sm:pb-1 lg:pb-2 xl:pb-2 pb-1  2xl:text-[23px] xl:text-[26px] lg:text-xl sm:text-[17px] text-[16px] w-full ease-in-out duration-500 flex font-normal block px-3 pr-4 xl:text-[25px] tracking-wide"
              />
            </div>
            ...
            <span className="px-2 my-auto">
              <img
                src={magnifier}
                className="text-black 2xl:w-[30px] xl:w-[28px] lg:w-[24px] sm:w-[20px] w-[20px] md:mx-0 mx-1"
              />{" "}
            </span>
          </div>
                ...
                <div className="flex">
                  <div className="my-auto">
                    <img
                      src={
                        selectedFilter === filter._id ||
                        hoveredFilter === filter._id
                          ? isLaptop
                            ? `http://localhost:4000/public/${filter.imageClicked}`
                            : selectedFilter === filter._id
                            ? `http://localhost:4000/public/${filter.imageClicked}`
                            : `http://localhost:4000/public/${filter.image}`
                          : `http://localhost:4000/public/${filter.image}`
                      }
                      className="2xl:w-[44px] h-[40px] xl:w-[38px] lg:w-[32px] sm:w-[26px] w-[24px] md:h-[26px] lg:h-[32px] h-auto xl:h-10 mr-2"
                    />
                  </div>
                  <div className="xl:mt-auto sm:my-auto my-auto mx-auto text-center">
                    {filter.title}
                  </div>
                </div>
              </span>
        ...
        {currentArticles.map((article) => (
          <RouteLink key={article._id} to={`/articles/${article._id}`}>
            <div className="w-full">
              <div className="z-[-1] relative bg-slate-200 aspect-[16/10]">
                <div className=" absolute bottom-0 lg:px-4 px-1 py-1 bg-gray-950 text-white uppercase tracking-widest ">
                  {article.label}{" "}
                </div>{" "}
              </div>
      ...
      <ReactPaginate
        ...
        containerClassName={
          "flex justify-center list-none  space-x-2 mb-[150px] p-4"
        }
        pageClassName={
          "border border-solid border-blue-200 lg:hover:bg-blue-300 lg:hover:border-blue-300 md:w-8 w-6 md:h-9 h-7 md:text-base text-sm flex items-center justify-center rounded-lg duration-300 ease-in-out"
        }
