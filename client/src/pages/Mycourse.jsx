...
function Mycourse(){
    ...
    <div className="max-w-[1240px] mx-auto  px-4  ">
        ...
        <div className="flex" >
        <ImageComponent src={reconstruction} styling="sm:h-[425px] h-[250px] max-w-[1240px] mx-auto mt-[-200px] md:mb-[300px] mb-[200px]" useHeight={250} useWidth={300} useHash="LNLWd|jr0[j[TLaxxZfl1nbHr;az"/>
        </div>
        </div>
