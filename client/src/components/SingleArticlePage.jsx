...
export default function SingleArticlePage({articles}) {
    ...
    return (
        <>
            ...
            <div className={
                `${
                    closeSideBar ? "2xl:max-w-[1680px] max-w-[1380px] mx-auto grid-flow-col grid-cols-2 xl:gap-x-20 md:gap-x-10 gap-x-3 mt-[120px] grid 2xl:pl-20 lg:pl-20 sm:pl-10 px-7" : "2xl:max-w-[1680px] max-w-[1380px] mx-auto grid-flow-col grid-cols-2 xl:gap-x-20 md:gap-x-10 gap-x-3 mt-[120px] grid 2xl:pl-20 lg:pl-20 sm:pl-10 pl-4"
                }`
            }>
                ...
                <div className="2xl:max-w-[1100px] col-span-2 xl:mt-0 sm:mt-[-40px] mt-[-120px]">
                    ...
                    <div className="md:mt-[125px] mt-20 flex justify-center">
                        <div className="text-center">
                            <h1 className="lg:text-2xl md:text-xl text-base font-bold mb-2">How do you rate this article?</h1>
                            ...
                            isModalOpen ? <div className="fixed top-0 left-0 bg-[#00000080] z-[10] h-[100vh] w-full flex justify-center items-center">
                                ...
                                {isMobile
                                    ...
                                    <>
                                        ...
                                        {
                                        showMoreLabels 
                                        ? <div className="cursor-pointer px-2 py-[1px] my-auto outline outline-1 outline-black outline-offset-[-1px] bg-white text-black rounded-2xl" onClick={()=> setShowMoreLabels(false)}>Less</div>
