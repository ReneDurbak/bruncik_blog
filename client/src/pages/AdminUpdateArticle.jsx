...
export default function AdminUpdateArticle() {
  ...
  const fetchArticleSections = async () => {
    try {
      ...
      const filteredArticleSections = fetchedArticleSections.filter(
        (section) => section._id !== articleSection._id
      );
    ...
    <div className="font-poppins flex space-x-[300px]">
      ...
      <div className="my-8 w-full ">
        <Link to="/admin/articles">
          <button className="p-2 rounded-xl bg-gray-200 hover:bg-gray-400 ease-in-out duration-300 my-2 cursor-pointer">
            Back
          </button>
        </Link>
        {article && (
          <>
            ...
            >
              ...
              <Select
                ...
                displayEmpty
                onChange={(e) => {
                  handleArticleSectionChange(e.target.value);
                  handleSetArticleSection(e.target.value);
                }}
                className="w-[25%]"
              >
                {articleSections &&
