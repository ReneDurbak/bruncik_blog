...
export default function Registration(){
  ...
  >
    ...
    <div className="mb-4">
      ...
      <input type="text" name="name" onChange={e=> setName(e.target.value)} className="shadow border duration-200 ease-in-out rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none mb-1 focus:shadow-lg outline-none" />
