...
export default function Email() {
  ...
  function sendEmail(e) {
    ...
    if (rgExp.test(email)) {
      ...
      emailjs
        .sendForm("test123", "tempEmail", e.target, "6Rv8j2Hq5xEQ8kKOX")
        .then((res) => {
          //console.log(res)
        })
          ...
          <div className="lg:mx-[75px]">
            <div className="">
              ...
              <input
                ...
                className="shadow border duration-200 ease-in-out  rounded w-full py-2 px-3 text-gray-700  leading-tight focus:outline-none focus:shadow-lg outline-none "
              />
              <div
                className={
                  error
            ...
            <div className="mt-4">
              <input
                type="submit"
                value="Send"
                className="flex  bg-gray-600 duration-200 ease-in-out py-1 px-3 mt-3 text-md  rounded-xl font-bold text-white hover:bg-gray-700 active:text-black"
              />
            </div>
          </div>
        </form>
