...
return(
  ...
  <div id="mystory" className="h-[1100px] bg-no-repeat bg-cover mt-[-100px]" style={{
      ...
      <div className="relative">
        <div className="bg-white p-4 2xl:w-[500px] 2xl:h-[250px] float-left 2xl:ml-20 mt-[50px] blur-xl rounded-[30px]">
        </div>
  ...
  <div className="max-w-full h-[1200px]">
    ...
    <div className="2xl:max-w-[1680px] max-w-[1380px] mx-auto 2xl:px-20 lg:px-20 sm:px-10 px-6 mt-[-350px] pt-[300px] ">
      ...
      <div className="grid grid-flow-col auto-cols-fr mt-20  2xl:gap-x-20 2xl:px-[100px]">

        {/*Health*/}
        <div className="relative py-5 2xl:px-8 2xl:h-[350px] bg-[#ACDC6F] rounded-[70px] custom-shadow-card">
          <img src={bottomShadow} className="absolute bottom-[-65px] left-2 z-[-1]"/>
        <div className="absolute w-[80%] top-[210px] border border-black"></div>
          <img src={health} className="float-right w-[125px] mr-4 mt-4"/>
        ...
        {/*Movement*/}
        <div className="relative py-5 2xl:px-8 2xl:h-[350px] bg-[#DC836F] rounded-[70px] custom-shadow-card">
          <img src={bottomShadow} className="absolute bottom-[-65px] left-2 z-[-1]"/>
        <div className="absolute w-[80%] top-[210px] border border-black"></div>
          <img src={movement} className="float-right w-[125px] mr-4 mt-4"/>
          <div className="pr-[100px] pt-[140px] pb-10">
        ...
        {/*Improvement*/}
        <div className="relative py-5 2xl:px-8 2xl:h-[350px] bg-[#6FD5DC] rounded-[70px] custom-shadow-card">
          <img src={bottomShadow} className="absolute bottom-[-65px] left-2 z-[-1]"/>
        <div className="absolute w-[80%] top-[210px] border border-black"></div>
          <img src={improvement} className="float-right w-[125px] mr-4 mt-4"/>
          <div className="pr-[100px] pt-[140px] pb-10">
  ...
  <div id="improvementSection" className="relative max-w-full 2xl:h-[1000px] pt-[190px]">
    ...
    <h1 className='text-3xl font-bold'>Love to hear from you, <br/> <div className="mt-2">Get in touch👋</div></h1>
    
    <div className="mt-5 mb-4">
      <label className="block text-gray-700 text-[15px] mb-3" >
        Your name
      </label>
      <input type="text" name="name" onChange={e=> setName(e.target.value)} className="shadow border rounded-[20px] bg-[#ECECEC] duration-200 ease-in-out w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none mb-1 focus:shadow-lg outline-none" />
      {error&&name.length<=0? <label className="text-red-400 font-bold lg:text-sm text-xs">Name can't be empty</label>:""}
    </div>
    ...
    <div className="mb-10">
      ...
      <input type="text" name="user_Email" onChange={e=>setEmail(e.target.value)} className="shadow border rounded-[20px] bg-[#ECECEC] duration-200 ease-in-out w-full py-2 px-3 text-gray-700  leading-tight focus:outline-none focus:shadow-lg outline-none "/>
  </div>


    <div className="mb-2">
      <label className="block text-gray-700 text-[15px] mb-3">Message</label> 
      <textarea rows={4} name="message" onChange={e => setMessage(e.target.value)} className="w-full bg-[#ECECEC] max-h-[175px] duration-200 ease-in-out px-3 py-2 rounded-[20px] shadow focus:shadow-md outline-none "/>
      <button 
        onMouseEnter={() => isLaptop ? setHoverOnSendButton(true) : setHoverOnSendButton(false)}
        ...
        className="flex justify-center space-x-2 w-full bg-black duration-700 ease-in-out py-2 px-3 mt-3 text-md  rounded-[20px] text-white lg:hover:bg-white lg:hover:text-black outline outline-[1px] outline-black active:bg-white active:text-black active:shadow-xl">
            <p>Send</p> 
            <img src={hoverOnSendButton || clickOnSendButton ? paperPlaneBlack : paperPlane} className="my-auto"/>
      </button>     
