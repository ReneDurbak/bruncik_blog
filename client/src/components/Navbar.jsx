...
return(
  ...
  <div className=" 2xl:p-5 lg:p-6 sm:p-5 p-4 md:flex md:items-center md:justify-between 2xl:max-w-[1680px] max-w-[1380px] mx-auto 2xl:px-20 lg:px-10 sm:px-10 px-6">
