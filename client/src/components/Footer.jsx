  ...
  <div className="flex flex-col xl:flex-row items-center justify-center xl:max-w-[1800px]   2xl:mx-auto sm:max-w-[600px]   xl:mx-4  mx-auto ">
    ...
    <div className="xl:basis-1/4 xl:border-l-4 xl:border-white  ">
      <ul className="text-white xl:text-base sm:text-xs text-[9px] xl:block flex xl:my-[-3px] my-4 uppercase font-bold tracking-wide">
        ...
        <li className="xl:mb-2 xl:mx-5 mx-1 my-auto underline underline-offset-4 decoration-0"><Link to="/about" className="hover:text-gray-400 duration-300 ease-in-out">Contact</Link></li>
      </ul>
    </div>
